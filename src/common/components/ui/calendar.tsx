  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          'bg-secondary text-slate-50 hover:bg-slate-900 hover:text-slate-50 focus:bg-secondary focus:text-slate-50 dark:bg-slate-50 dark:text-slate-900  dark:focus:text-slate-900',
        day_today: 'bg-primary text-slate-200',
        day_outside:
